...
var (
	...
	mysqlDB            = flag.String("mysql-database", getEnv("MYSQL_DATABASE", "flow-documents"), "MySQL database")
	mysqlUser          = flag.String("mysql-user", getEnv("MYSQL_USER", "flow-documents"), "MySQL user")
